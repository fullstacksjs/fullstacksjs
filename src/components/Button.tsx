...
export const Button = ({
  ...
  return (
    <Comp
      className={cn(
        'flex flex-row items-center justify-center rounded-lg px-12 py-4 text-sm/snug font-semibold hover:cursor-pointer disabled:cursor-auto disabled:border-none disabled:bg-bg-muted disabled:text-fg-muted',
        {
